...
Start-Process powershell.exe '..\Script\Tree.ps1'
...
$RefinedData = $data | Select-Object  @{Name = "Name"; Expression = {$_.Surname + ", " + $_.GivenName}}, `
...
$refineddata | ForEach-Object {
    ...
    $_ | Select-Object @{Name = "Path"; Expression = {$subou.DistinguishedName}}, * | New-ADUser  
}
